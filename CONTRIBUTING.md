# Contributing to mixs-missing-value-sandbox

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
mixs-missing-value-sandbox. These guidelines are not strict rules.
...
The mixs-missing-value-sandbox team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the mixs-missing-value-sandbox technical leads
...
[issues]: https://github.com/GenomicsStandardsConsortium/mixs-missing-value-sandbox/issues/
[pulls]: https://github.com/GenomicsStandardsConsortium/mixs-missing-value-sandbox/pulls/
